<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="ui.html"><i class="icon-eye-open"></i><span class="hidden-tablet"> Reports </span></a></li>
						...
						<li><a class="ajax-link" href="table.html"><i class="icon-align-justify"></i><span class="hidden-tablet"> Configuration Settings</span></a></li>
							<li><a class="ajax-link" href="calendar.html"><i class=" icon-user"></i><span class="hidden-tablet"> Users </span></a></li>
