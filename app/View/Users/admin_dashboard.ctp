		...
		<footer>
			<p class="pull-left">&copy; <a href="http://usman.it" target="_blank">Library Ideas</a> 2014</p>
			<p class="pull-right">Powered by: <a href="http://usman.it/free-responsive-admin-template">InfoBeans</a></p>
		</footer>
